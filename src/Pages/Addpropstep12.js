...
function Addpropstep12 (){
    ...
    const saveDraft=()=>{
      ...
      sendpropertyDetails(propertytype,propertylistingpurpose,
        propertyinternalfeatures,propertyexternalfeatures,
        propertynearbyfeatures,propertyroomsperunit,
        propertypriceperunit,propertylocation);
                  ...
                  {/* onSubmit={handleClick} */}
                      <Form method="" ref={form} onSubmit={handleClick} >           
                          ...
                          <div style={{ width:"100%", margin:"1rem 0rem 1rem 1rem"}}>
                            <Backbutton to="/properties/list-property/step11"  sidebar={side? 1:0} >Back</Backbutton>    
                            {/* onClick={saveBack} */}
                            {disabled?
                            <Button disableed={disabled?1:0} type='submit' style={{padding:"0.5rem 1rem", margin:"0.5rem"}}>Next Step</Button>
                            : 
                            // <Nextbutton to={path} onClick={saveDraft} disabled={disabled?1:0}>Complete Property Registration</Nextbutton>
                            <Nextbutton  onClick={saveDraft} disabled={disabled?1:0}>Complete Property Registration</Nextbutton>
